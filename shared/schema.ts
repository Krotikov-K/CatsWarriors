...
export const LOCATIONS_DATA = [
  ...
  { id: 7, name: "Старая Дорога", type: "neutral", clan: null, dangerLevel: 4, x: 20, y: 75, connectedTo: [4, 10], emoji: "🛤️" },
  ...
  { id: 13, name: "Заброшенная Пещера", type: "neutral", clan: null, dangerLevel: 5, x: 115, y: 45, connectedTo: [12, 14], emoji: "🕳️" },
  { id: 14, name: "Древний Храм", type: "sacred", clan: null, dangerLevel: 3, x: 125, y: 60, connectedTo: [13, 15], emoji: "🏛️" },
  { id: 15, name: "Мистический Водопад", type: "special", clan: null, dangerLevel: 4, x: 135, y: 75, connectedTo: [14], emoji: "💧" },
  
  // Нижняя область карты
  { id: 16, name: "Болотистая Низина", type: "hunting", clan: null, dangerLevel: 4, x: 25, y: 95, connectedTo: [7, 17], emoji: "🌾" },
  { id: 17, name: "Туманные Холмы", type: "neutral", clan: null, dangerLevel: 5, x: 45, y: 110, connectedTo: [10, 16, 18], emoji: "🌫️" },
  { id: 18, name: "Край Света", type: "special", clan: null, dangerLevel: 8, x: 65, y: 125, connectedTo: [17], emoji: "🌌" },
] as const;
