...
export const LOCATIONS_DATA = [
  // Племенные лагеря
  { id: 1, name: "Лагерь Грозового Племени", type: "camp", clan: "thunder", dangerLevel: 1, x: 30, y: 40, connectedTo: [3], emoji: "🏠" },
  { id: 2, name: "Лагерь Речного Племени", type: "camp", clan: "river", dangerLevel: 1, x: 70, y: 60, connectedTo: [6], emoji: "🏕️" },
  
  // Центральные локации
  { id: 3, name: "Четыре Дерева", type: "neutral", clan: null, dangerLevel: 2, x: 50, y: 50, connectedTo: [1, 4, 5], emoji: "🌳" },
  { id: 4, name: "Солнечная Поляна", type: "hunting", clan: null, dangerLevel: 2, x: 40, y: 60, connectedTo: [3, 7], emoji: "🌻" },
  { id: 5, name: "Лесная Тропа", type: "hunting", clan: null, dangerLevel: 3, x: 60, y: 40, connectedTo: [3, 6, 8], emoji: "🌲" },
  ...
  { id: 8, name: "Поле Битв", type: "combat", clan: null, dangerLevel: 5, x: 70, y: 30, connectedTo: [5, 9, 11], emoji: "⚔️" },
  { id: 9, name: "Каменистая Гора", type: "combat", clan: null, dangerLevel: 4, x: 80, y: 40, connectedTo: [6, 8, 10, 12], emoji: "⛰️" },
  { id: 10, name: "Лунный Камень", type: "sacred", clan: null, dangerLevel: 1, x: 60, y: 70, connectedTo: [7, 9], emoji: "🌙" },
  
  // Расширенная область карты (дальние локации)
  { id: 11, name: "Дальний Лес", type: "hunting", clan: null, dangerLevel: 6, x: 90, y: 25, connectedTo: [8, 12], emoji: "🌿" },
  { id: 12, name: "Горный Пик", type: "combat", clan: null, dangerLevel: 7, x: 95, y: 35, connectedTo: [9, 11, 13], emoji: "🏔️" },
  { id: 13, name: "Заброшенная Пещера", type: "neutral", clan: null, dangerLevel: 5, x: 105, y: 45, connectedTo: [12], emoji: "🕳️" },
  
  // Нижняя область карты
  { id: 16, name: "Болотистая Низина", type: "hunting", clan: null, dangerLevel: 4, x: 35, y: 80, connectedTo: [7, 17], emoji: "🌾" },
  { id: 17, name: "Туманные Холмы", type: "neutral", clan: null, dangerLevel: 5, x: 55, y: 85, connectedTo: [10, 16], emoji: "🌫️" },
] as const;
